...
def get_sampled_indices(BTObj, y, protected_label, method = "Downsampling"):
    ...
    # init a dict for storing the index of each group.
    print( "get_sampled_indices",BTObj, y, "pl:", protected_label, "method:", method , "total", len(y))
    group_idx = {}
    if BTObj in ["joint", "stratified_y", "stratified_g", "EO"]:
    ...
    for idx, group_label in enumerate(group_labels):
        #adds a new entry to the dict array at index [group_label]
    ...
    if BTObj in ["joint", "y", "g"]:
        ...
        #print ("here3")
        print (distinct_g_label, distinct_y_label)
        #print ("here4")
        ...
        for y in distinct_y_label:
            if method == "Downsampling":
                ...
                print ("here5")
                print([(group_idx.get((y, _g))) for _g in distinct_g_label])
                #for  _g in distinct_g_label:
                #    print (_g, y, group_idx.get((y, _g)))
